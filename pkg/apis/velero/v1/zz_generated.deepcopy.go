...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EncryptionKeyRetrieverConfig) DeepCopyInto(out *EncryptionKeyRetrieverConfig) {
	{
		in := &in
		*out = make(EncryptionKeyRetrieverConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EncryptionKeyRetrieverConfig.
func (in EncryptionKeyRetrieverConfig) DeepCopy() EncryptionKeyRetrieverConfig {
	if in == nil {
		return nil
	}
	out := new(EncryptionKeyRetrieverConfig)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *EncryptionStatus) DeepCopyInto(out *EncryptionStatus) {
	*out = *in
	if in.KeyRetrieverConfig != nil {
		in, out := &in.KeyRetrieverConfig, &out.KeyRetrieverConfig
		*out = make(EncryptionKeyRetrieverConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
