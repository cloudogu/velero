...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EncryptionKeyLocation) DeepCopyInto(out *EncryptionKeyLocation) {
	{
		in := &in
		*out = make(EncryptionKeyLocation, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EncryptionKeyLocation.
func (in EncryptionKeyLocation) DeepCopy() EncryptionKeyLocation {
	if in == nil {
		return nil
	}
	out := new(EncryptionKeyLocation)
	in.DeepCopyInto(out)
	return *out
}
